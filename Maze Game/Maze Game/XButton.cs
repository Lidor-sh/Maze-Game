...

{
...

    {
        ...
        private Maze_Game.Theme thm = Maze_Game.Theme.MSOffice2010_BLUE;
...

        {
            ...
            if (thm == Maze_Game.Theme.MSOffice2010_BLUE || thm == Maze_Game.Theme.MSOffice2010_Green || thm == Maze_Game.Theme.MSOffice2010_Yellow || thm == Maze_Game.Theme.MSOffice2010_Publisher ||

                thm == Maze_Game.Theme.MSOffice2010_RED || thm == Maze_Game.Theme.MSOffice2010_WHITE || thm == Maze_Game.Theme.MSOffice2010_Pink)
...

        {
...

            {
...

                {
                    ...
                    return Maze_Game.Theme.MSOffice2010_Green;
...

                {
                    ...
                    return Maze_Game.Theme.MSOffice2010_RED;
...

                {
                    ...
                    return Maze_Game.Theme.MSOffice2010_Pink;
...

                {
                    ...
                    return Maze_Game.Theme.MSOffice2010_Yellow;
...

                {
                    ...
                    return Maze_Game.Theme.MSOffice2010_WHITE;
...

                {
                    ...
                    return Maze_Game.Theme.MSOffice2010_Publisher;

                }



                return Maze_Game.Theme.MSOffice2010_BLUE;
...

            {
                ...
                if (thm == Maze_Game.Theme.MSOffice2010_Green)
                ...
                else if (thm == Maze_Game.Theme.MSOffice2010_RED)
                ...
                else if (thm == Maze_Game.Theme.MSOffice2010_Pink)
                ...
                else if (thm == Maze_Game.Theme.MSOffice2010_WHITE)
                ...
                else if (thm == Maze_Game.Theme.MSOffice2010_Yellow)
                ...
                else if (thm == Maze_Game.Theme.MSOffice2010_Publisher)
